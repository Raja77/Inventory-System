...
CREATE TABLE [dbo].[tbComments] (
    ...
    [CommentCreatorName]      NVARCHAR (200) NULL,
    [CommentSubject]     NVARCHAR (100) NULL,
    [CommentDescription] NVARCHAR (50)  NULL,
    [CommentPageName]    NVARCHAR (50)  NULL,
    [CommentCreatedOn] DATE NULL, 
	[CommentReplierName]      NVARCHAR (200) NULL,
	[CommentReply] NVARCHAR (50)  NULL,
	[CommentRepliedOn] DATE NULL, 
    CONSTRAINT [PK_tbComments] PRIMARY KEY CLUSTERED ([CommentId] ASC)
);
