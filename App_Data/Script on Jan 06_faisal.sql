...
IF @ActionType = 'SaveCategory'  
	...
	IF @ActionType = 'FetchSubCategories'  
		BEGIN  
			Select CategoryName,CategoryDescription, SubCategoryName, SubCategoryDescription, SubCategoryId from tbCategories c, tbSubCategory sc where c.CategoryId=sc.CategoryId
		END 
