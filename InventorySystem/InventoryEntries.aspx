        ...
        <asp:GridView ID="grdInventoryMaster" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
            ...
            <Columns>
                        ...
                        <asp:Panel ID="pnlIssueDetails" runat="server" Style="display: none">
                            <asp:GridView ID="grdIssueDetailDisplay" runat="server" AutoGenerateColumns="false" DataKeyNames="IssueId"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="UserName" HeaderText="Issued To" ItemStyle-Width="10%" ><HeaderStyle /></asp:BoundField>
                                    <asp:BoundField DataField="IssueDate" HeaderText="Date of Issue" ItemStyle-Width="20%" ><HeaderStyle /></asp:BoundField>
                                    <asp:BoundField DataField="IssueQuantity" HeaderText="Quantity" ItemStyle-Width="10%" ><HeaderStyle /></asp:BoundField>
                                    <asp:BoundField DataField="IsReceived" HeaderText="Is Recieved" ItemStyle-Width="10%" ><HeaderStyle /></asp:BoundField>
                                    <asp:BoundField DataField="IssuerRemarks" HeaderText="Issuer Remarks" ItemStyle-Width="20%" ><HeaderStyle /></asp:BoundField>
                                    <asp:BoundField DataField="ReceiptRemarks" HeaderText="Receiver Remarks" ItemStyle-Width="20%" ><HeaderStyle /></asp:BoundField>
                                </Columns>
                            </asp:GridView>
                        </asp:Panel>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Register No">
                    <ItemTemplate><asp:Label ID="lblInventoryRegisterNo" runat="server" Text='<%#Eval("InventoryRegisterNo") %>'></asp:Label></ItemTemplate>
                    <EditItemTemplate><asp:TextBox ID="txtInventoryRegisterNo" runat="server" Text='<%#Eval("InventoryRegisterNo") %>'></asp:TextBox></EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Register Page No">
                    <ItemTemplate><asp:Label ID="lblInventoryPageNo" runat="server" Text='<%#Eval("InventoryPageNo") %>'></asp:Label></ItemTemplate>
                    <EditItemTemplate><asp:TextBox ID="txtInventoryPageNo" runat="server" Text='<%#Eval("InventoryPageNo") %>'></asp:TextBox></EditItemTemplate>
                </asp:TemplateField>
                    <asp:TemplateField HeaderText="Purchase Date">
                    <ItemTemplate><asp:Label ID="lblPurchaseDate" runat="server" Text='<%#Eval("PurchaseDate") %>'></asp:Label></ItemTemplate>
                    <EditItemTemplate><asp:TextBox ID="txtPurchaseDate" runat="server" Text='<%#Eval("PurchaseDate", "{0: dd-MMM-yyyy}") %>'></asp:TextBox>
                    <div class="col-sm-2">
                ...
                <asp:TemplateField HeaderText="IsConsumable">
                    ...
                    <EditItemTemplate><asp:CheckBox ID="chkIsConsumable" runat="server" Checked='<%#Eval("IsConsumable") %>'></asp:CheckBox></EditItemTemplate>
